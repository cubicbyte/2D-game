...
export namespace DefaultWorld {
    export namespace Generator {
        ...
        let Air: BlockSubclass,
            Bedrock: BlockSubclass,
            Cobblestone: BlockSubclass,
            Dirt: BlockSubclass,
            Grass: BlockSubclass,
            IronOre: BlockSubclass,
            Leaves: BlockSubclass,
            Log: BlockSubclass,
            Stone: BlockSubclass

        export function create(params: DefaultWorldGeneratorParameters = {}) {
            Air = Engine.getBlockById('game:air') as BlockSubclass
            Bedrock = Engine.getBlockById('game:bedrock') as BlockSubclass
            Cobblestone = Engine.getBlockById('game:cobblestone') as BlockSubclass
            Dirt = Engine.getBlockById('game:dirt') as BlockSubclass
            Grass = Engine.getBlockById('game:grass') as BlockSubclass
            IronOre = Engine.getBlockById('game:iron_ore') as BlockSubclass
            Leaves = Engine.getBlockById('game:leaves') as BlockSubclass
            Log = Engine.getBlockById('game:log') as BlockSubclass
            Stone = Engine.getBlockById('game:stone') as BlockSubclass
